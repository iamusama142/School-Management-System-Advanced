...
<!-- auth-login  21 Nov 2019 03:49:32 GMT -->
...
<head>
    ...
    <link rel="stylesheet" href="{{asset('Res/assets/bundles/bootstrap-social/bootstrap-social.css')}}">
    <!-- Template CSS -->
...
<body>
                                    ...
                                    <div class="form-group">
                                        <div class="d-block">
                                            ...
                                            <div class="float-right">
                                                <a href="auth-forgot-password" class="text-small">Forgot Password?</a>
                                            </div>
                                        </div>
    ...
    <!-- General JS Scripts -->
    <script src="{{asset('Res/assets/js/app.min.js')}}"></script>
    <!-- JS Libraies -->
    <!-- Page Specific JS File -->
    <!-- Template JS File -->
    <script src="{{asset('Res/assets/js/scripts.js')}}"></script>
    <!-- Custom JS File -->
    <script src="{{asset('Res/assets/js/custom.js')}}"></script>
</body>
